...
//    WonderPushInstance wonderPushInstance;
//
//
//    public MethodHandler(Context context,Activity activity, MethodChannel methodChannel){
//        this.context=context;
//        this.mainActivity=activity;
//        this.methodChannel= methodChannel;
//        this.wonderPushInstance=WonderPushInstance.getInstance(methodChannel);
//    }
//
//    @Override
...
//
//            case "init":
//                wonderPushInstance.setupWonderPush(this.context,call.argument("clientId").toString(),call.argument("clientSecret").toString());
...
//                wonderPushInstance.subscribeToEvent(eventType);
...
//
//            case "addTag":
//                wonderPushInstance.updateTags(call.argument("tags"),"addTag");
//                break;
//
//            case "removeTag":
//                wonderPushInstance.updateTags(call.argument("tags"),"removeTag");
//                break;
//
//            case "removeAllTags":
