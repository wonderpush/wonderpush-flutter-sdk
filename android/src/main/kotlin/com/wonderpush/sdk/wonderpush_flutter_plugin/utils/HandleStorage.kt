 ...
 *
 * MessageHandle: Is the top level or static method that the user defines and passes to the `wp.setNotificationListener`.
 */
internal object HandleStorage {
    private const val SHARED_PREFERENCES_KEY = "wp_storage"
    private const val BACKGROUND_SETUP_CALLBACK_HANDLE_KEY = "wp_background_setup_handle"
    private const val BACKGROUND_MESSAGE_CALLBACK_HANDLE_KEY = "wp_background_message_handle"
